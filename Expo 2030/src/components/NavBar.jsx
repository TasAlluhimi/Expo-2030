    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between mx-auto p-4">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="https://riyadhexpo2030.sa/wp-content/uploads/2023/02/Riyadh_Expo_2030-Logo-Colored-ar.png" className="h-16" alt="Logo" />
        ...
        {loggedIn ? (
              <div className="relative">
                ...
                >
                  ...
                  <img className="w-9 h-9 rounded-full" src="https://cdn-icons-png.flaticon.com/128/149/149071.png" alt="user photo" />
                </button>
                {showUserMenu && (
